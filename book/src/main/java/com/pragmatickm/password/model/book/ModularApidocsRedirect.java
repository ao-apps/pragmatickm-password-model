...
package com.pragmatickm.password.model.book;
...
@WebServlet("/password/model/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
      ...
      "/password/model/apidocs/com.pragmatickm.password.model/com" + Objects.toString(req.getPathInfo(), ""),
