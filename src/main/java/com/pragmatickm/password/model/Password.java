...
public class Password extends Element {
  ...
  public static class CustomField {
    ...
    public CustomField(PageRef pageRef, String element, String value) {
      ...
      if (pageRef == null && value == null) {
        throw new IllegalArgumentException("At least one of page or value must be provided.");
      }
  ...
  public void addCustomField(String name, PageRef pageRef, String element, String value) {
    ...
    synchronized (lock) {
      ...
      if (customFields.put(name, new CustomField(pageRef, element, value)) != null) {
        throw new IllegalStateException("Duplicate custom field: " + name);
      }
      if (pageRef != null) {
        addPageLink(pageRef);
      }
  ...
  public void addSecretQuestion(String question, String answer) {
    ...
    synchronized (lock) {
      checkNotFrozen();
      if (secretQuestions == null) {
        secretQuestions = new LinkedHashMap<>();
      }
      if (secretQuestions.put(question, answer) != null) {
        throw new IllegalStateException("Duplicate secret question: " + question);
      }
    }
  }
